...
<body>
	...
	<div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <a href="{{'/secondary/article/pull/details/'.$post->contribution->id}}" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @endforeach
        <p>Do you want to pull  from original Article? Click <a href="{{url('/secondary/pull/'. $id)}}">here</a></p>
		{{ $posts->links() }}
	</div>
	<!-- Optional JavaScript -->
